...
class ContactApi(object):
    ...
    def get_contact_by_id_with_http_info(self, contact_id, **kwargs):  # noqa: E501
        ...
        if ('contact_id' not in params or
                params['contact_id'] is None):
            raise ValueError("Missing the required parameter `contact_id` when calling `get_contact_by_id`")  # noqa: E501
    ...
    def get_contacts_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'limit' in params and params['limit'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_contacts`, must be a value less than or equal to `10000`")  # noqa: E501
        if 'limit' in params and params['limit'] < 11:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_contacts`, must be a value greater than or equal to `11`")  # noqa: E501
        collection_formats = {}
