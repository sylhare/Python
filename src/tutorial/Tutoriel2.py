...
bool=False
if variable==9 or bool is not True and a!=0:
    print("a:",a,"et",variable, "mais bool est", bool)
...
print(chaine)
print("En minuscule : "+chaine.lower()+ " en majuscule "+chaine) #Sort la chaine en minuscule mais ne la change pas
...
s = set(temp2);[x for x in temp1 if x not in s] #fastest
